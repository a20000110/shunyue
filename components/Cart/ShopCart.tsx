                ...
                <form>
                    ...
                    <section aria-labelledby="summary-heading" className="mt-10">
                        ...
                        <div className="mt-10">
                            <button
                                type="submit"
                                className="w-full rounded-md border border-transparent bg-main px-4 py-3 text-base font-medium text-white shadow-sm hover:opacity-80 focus:outline-none "
                            >
                                Checkout
                            </button>
                        </div>
